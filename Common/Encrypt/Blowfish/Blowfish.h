...
#define ECB 0  // Electronic code block
#define CBC 1  // Encrypted block chain
#define CFB 2  // Encrypted feedback
#define MAX_KEY_SIZE 56
#define MAX_PBLOCK_SIZE 18     // PBLOCK size
#define MAX_SBLOCK_XSIZE 4     // SBLOCK size
#define MAX_SBLOCK_YSIZE 256   // SBLOCK column size

#define KEY  ("!HerculesAntiCheat!")
